_satellite.logger.debug("***********************New Launch z_appmeasurement_prd code *************");

window.tmLoadScript = function tmLoadScript(e,t){var a=document.createElement("script");a.type="text/javascript",a.readyState?a.onreadystatechange=function(){"loaded"!=a.readyState&&"complete"!=a.readyState||(a.onreadystatechange=null,t())}:a.onload=function(){t()},a.src=e,document.getElementsByTagName("head")[0].appendChild(a)}
...
myPlayer.on('ads-ad-started',function(){
       log("++ads-ad-started - " + myPlayer.mediainfo.name, prod);
  });
