...
}).then(function(){xo(c)})["catch"](function(e){c.c.error("Error while loading thumbnail index",e)})};wo.prototype.get=function(a){var b=this;return 0>a?Promise.reject(co+a):this.f.then(function(){for(var c=0;c<b.a.length;c++){var d=b.a[c];if(d.time>=a&&a<d.time+d.duration)return zo(b,d).then(function(e){return e.load().then(function(){return e})})}return Promise.reject(bo+a)})};var Ao=[137,66,73,70,13,10,26,10];};
