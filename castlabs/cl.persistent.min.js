...
6);case 6:return _.x(l,_.wk(d),7);case 7:return _.x(l,Promise.all(f.sessionIds.map(function(m){return _.A(function(n){if(1==n.a)return _.x(n,Mr(d,m),2);c.debug("sucessfully removed session with id",m);_.y(n)})})),8);case 8:return _.x(l,b["delete"](a),3);case 3:return Er(l),g=[],d&&g.push(d.destroy()),e&&g.push(e.destroy()),_.x(l,Promise.all(g),10);case 10:Fr(l);break;case 2:throw h=_.Ee(l),c.error("Failed to remove session"),new _.J(1,6,6201,null,h);}})});var Nr=new Qr,Sr=new _.H(Dr);};
