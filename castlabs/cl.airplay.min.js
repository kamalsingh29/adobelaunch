...
_.r.Dd=function(){return this.c};_.r.yj=function(){this.c&&(this.h=!this.a.isPaused(),this.b.webkitShowPlaybackTargetPicker())};_.B("clpp.airplay.AirPlayPlugin",VD);VD.prototype.showCastMenu=VD.prototype.yj;VD.prototype.canCast=VD.prototype.Dd;VD.prototype.isCasting=VD.prototype.Ka;VD.Id="airplay";WD.prototype.create=function(){return new VD};_.xn(new WD);};
