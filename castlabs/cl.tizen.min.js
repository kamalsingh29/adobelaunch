...
var f=function(window){var ex="An unknown error occured while trying to get volume",fx="Cannot get loading rendition due to platform limitations",gx="SecurityError",hx="The require privilege is: http://tizen.org/privilege/tv.audio",ix="|STARTBITRATE\x3d",jx=function(a,b){var c={},d=null!==a.parentElement?window.getComputedStyle(a,null):a.style;if(!b||0===b.length){b||(b=[]);for(var e in d)b.push(e)}b.forEach(function(f){c[f]=d[f]});return c},kx=function(a,b,c){function d(e){c.call(a,e);a.removeEventListener(b,d)}a.addEventListener(b,
